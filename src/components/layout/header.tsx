    ...
    <header className="bg-white/95 backdrop-blur-lg border-b border-gray-200 px-4 sm:px-6 py-4 shadow-lg animate-slide-down">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="relative animate-fade-in">
            ...
            <Input
              ...
              className="pl-10 w-60 sm:w-80 bg-white/50 border-gray-200 focus:bg-white focus:border-blue-300 transition-all duration-300"
            />
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 animate-slide-in-right">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 p-2 rounded-lg hover:bg-gray-50 transition-all duration-300 cursor-pointer group">
